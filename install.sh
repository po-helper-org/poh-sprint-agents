#!/usr/bin/env bash
# poh-sprint-agents installer — копирует навыки sprint-planner и sprint-result
# в target-проект (Claude Code).
...
for c in sm-sync sm-goal sm-decompose sm-load sm-deliver sm-consensus \
         sprint-result sr-revise sr-final sr-html; do
