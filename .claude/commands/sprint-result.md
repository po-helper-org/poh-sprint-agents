...
Роль: Fact Collector → Report Builder. Прочитай `.claude/domain-profile.md`, `SKILL.md`, `resources/resync_questions.md`, `resources/readiness_ladder.md`, `resources/report_structure.md`, `resources/comment_logic.md`, `resources/writing_register.md`, `resources/fact_gates.md`, `examples/ideal_sprint_report.md`.
