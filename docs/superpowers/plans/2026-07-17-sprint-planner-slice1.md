...
- [ ] **Step 2: Написать эталон `ideal_operational_contract.md`** (2 исполнителя, данные из `ideal_sprint_plan.md` — BE-2 медиа, BE-1 B2B)
...
- FE-1: SP «FE: витрина медиа» 5 → 8 (команда: недооценили фильтрацию) → **ре-прогон гейтов**: FE-1 стал 🟢 100%, добор снят.
...
## ЦЕЛЬ: Медиа (OBJ 2)
**🎯 Образ результата команды (Sprint Goal):** медиа на витрине
...
- [ ] **Step 1: Написать fixture-файлы** (домен «Витрина», согласован с `ideal_sprint_plan.md`)
...
|-------------|-----------|-----------|
| BE-1 | Backend | КОР, gw_go |
| BE-2 | Backend | HUB, store_db |
...
`SPRINT-ROADMAP-2026Q3.md`: матрица KR×спринт по формату `sprint_standards.md` (OBJ2 KR2.1 медиа, OBJ3 KR3.1 B2B; срез на S7).
